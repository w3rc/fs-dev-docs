...
1. **Download the Workflow Files:**
   ...
   - [**Workflow:**](https://flowscale-prod.s3.us-east-1.amazonaws.com/docs/flux_lora_trainer.json)
   - [**API Version of the Workflow:**](https://flowscale-prod.s3.us-east-1.amazonaws.com/docs/flux_lora_trainer_api.json)
